...
import logopictures from '../assets/team/GreenlandPictures.png'

import genial from '../assets/team/genial.jpg'
import salum from '../assets/team/salum.jpg'
import vasco from '../assets/team/vasco.jpg'
import kind from '../assets/team/kind.jpg'
import ceo from '../assets/team/ceo.jpeg'
import seth from '../assets/team/seth.jpg'
import secretaire from '../assets/team/secretaire.jpg'
...
import partner16 from '../assets/partners/00.png';
...
import partner26 from '../assets/partners/26.png';
import partner27 from '../assets/partners/27.png';
import partner28 from '../assets/partners/28.png';
import partner29 from '../assets/partners/29.png';
import partner30 from '../assets/partners/30.png';
import partner31 from '../assets/partners/31.png';
import partner32 from '../assets/partners/32.png';
import partner33 from '../assets/partners/33.png';
...
import corporatesImg1 from '../assets/corporates/28.jpg';
import eventsImg1 from '../assets/events/24.jpg';
import graphicsImg1 from '../assets/graphics/9.jpg';
import hotelsImg1 from '../assets/hotels/26.jpg';
import productsImg1 from '../assets/Products/9.jpg';
import productsImg2 from '../assets/Hotels/17.jpg';
import productsImg3 from '../assets/products/3.jpg';
import productsImg4 from '../assets/Hotels/21.jpg';
import productsImg5 from '../assets/Wildlife/3.jpg';
import realestatesImg1 from '../assets/realestates/1.jpg';
import wildlifeImg1 from '../assets/wildlife/9.jpg';
...
import shewasntmeImg from '../assets/catalogs/shewasntme.png';
import incubationImg from '../assets/catalogs/incubation.png';
...
const HomePage = () => {
  ...
  const teamMembers = [
    {
      id: 1,
      name: 'Deus Dedit Sangwa',
      role: 'Managing and Creative Director',
      description: 'Visionary leader overseeing creative direction and company strategy. Brings innovative approaches to storytelling and production.',
      image: ceo, 
      specialties: ['Creative Direction', 'Strategic Planning', 'Leadership']
    },
    
    {
      id: 7,
      name: 'Imanirakiza Aimable',
      role: 'Project Manager',
      description: 'A dedicated team member contributing creativity and passion to every project.',
      image: kind,
      specialties: ['Collaboration', 'Creativity', 'Dedication']
    },
    {
      id: 5,
      name: 'Mbabazi Marie Solange',
    ...
    {
      id: 4,
      name: 'Sallum Iyongize',
      role: 'Head of Photography Department',
      description: 'Leads the creative design team in developing visual concepts and brand identities.',
      image: salum, 
      specialties: ['Graphic Design', 'Visual Storytelling', 'Creative Direction']
    },  
    {
      id: 2,
      name: 'Kamaal Genial',
      role: 'Head of Editing department',
      description: 'Ensures smooth execution of all productions with meticulous planning and resource management.',
      image: genial,
      specialties: ['Production Coordination', 'Logistics', 'Team Management']
    },
    {
      id: 3,
      name: 'Manzi Prince',
      role: 'Video Director',
      description: 'Manages company communications, public image, and strategic stakeholder relationships.',
      image: vasco,
      specialties: ['Public Relations', 'Communications', 'Brand Management']
    },
    {
      id: 6,
      name: 'Gisubizo Seth',
  ...
  // Catalogue categories (for grid)
  const catalogueCategories = [
    {
      id: 1,
      title: 'SHE CAN',
      description: 'A short film celebrating female empowerment and resilience.',
      image: shecanImg,
      count: '00:22:12',
    },
    {
      ...
      description: 'An action Thriller of an undercover spy posing as a teacher, who teams up with brave students to stop a human trafficking.',
      image: incubationImg,
      count: '01:36:46',
    },
    {
      id: 3,
      title: "SHE WASN'T ME",
      description: 'A drama delving into questions of identity and self-discovery.',
      image: shewasntmeImg,
      count: '00:11:15',
    },
    {
      id: 4,
      title: 'ACE OF HEARTS',
      description: 'A romantic mystery feature film with unexpected twists.',
      image: aceofheartImg,
      count: '01:42:13',
    },
    {
      id: 5,
      title: 'ITARA',
      description: 'A short film illuminating the power of hope and light.',
      image: itaraImg,
      count: '00:25:20',
    },
    {
      id: 6,
      title: 'NDATEGEREJE',
      description: 'An abstract cultural series inspired by Rwandan heritage.',
      image: ndategerejeImg,
      count: 'series',
    },
    {
      id: 7,
      title: 'FORGIVEN NOT FORGOTTEN',
      description: 'A documentary about forgiveness and reconciliation.',
      image: forgiven,
      count: '00:18:20',
    },
    {
      id: 8,
      title: 'INTRUSION',
      description: 'A suspenseful story of unexpected events.',
      image: intrusion,
      count: '00:06:34',
    },
  ];
  ...
  const partners = [
    ...
    // { id: 22, name: 'Partner 22 Name', logo: partner22, description: 'Partner 22 description' },
    { id: 23, name: 'Partner 23 Name', logo: partner23, description: 'Partner 23 description' },
  { id: 24, name: 'Partner 24 Name', logo: partner24, description: 'Partner 24 description' },
  { id: 25, name: 'Partner 25 Name', logo: partner25, description: 'Partner 25 description' },
  { id: 26, name: 'Partner 26 Name', logo: partner26, description: 'Partner 26 description' },
  { id: 27, name: 'Partner 27 Name', logo: partner27, description: 'Partner 27 description' },
  { id: 28, name: 'Partner 28 Name', logo: partner28, description: 'Partner 28 description' },
  { id: 29, name: 'Partner 29 Name', logo: partner29, description: 'Partner 29 description' },
  { id: 30, name: 'Partner 30 Name', logo: partner30, description: 'Partner 30 description' },
  { id: 31, name: 'Partner 31 Name', logo: partner31, description: 'Partner 31 description' },
  { id: 32, name: 'Winnaz', logo: partner32, description: 'Winnaz' },
  { id: 31, name: 'Partner 31 Name', logo: partner33, description: 'Partner 31 description' },
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="animate-slide-in-left">
              <h2 className="text-4xl md:text-5xl font-playfair font-bold italic mb-8 header-greenland text-center" style={{ position: 'relative', display: 'inline-block' }}>
                About
                <div className="w-24 header-underline mx-auto mt-2"></div>
              </h2>
...
creativity, and storytelling excellence worldwide</p>
            ...
            <div className="animate-slide-in-right">
              <img src={logopictures} alt="Photographer at work" className="rounded-lg shadow-2xl hover:scale-105 transition-transform duration-300" />
            </div>
          </div>
        </div>
      </section>
      ...
      >
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16 animate-fade-in">
            <h2 className="text-4xl md:text-5xl font-playfair font-bold italic mb-8 header-greenland">Photos</h2>
            <div className="w-24 header-underline mx-auto mb-8"></div>
      ...
      >
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16 animate-fade-in">
            <h2 className="text-4xl md:text-5xl font-playfair font-bold italic mb-8 header-greenland">Cinematic Moments</h2>
            <div className="w-24 header-underline mx-auto mb-8"></div>
...
>
  <div className="max-w-7xl mx-auto">
    <div className="text-center mb-16 animate-fade-in">
      <h2 className="text-4xl md:text-5xl font-playfair font-bold italic mb-8 header-greenland">Meet the Team</h2>
      <div className="w-24 header-underline mx-auto mb-8"></div>
    ...
    {/* First row: Deus Dedit Sangwa centered */}
    <div className="flex justify-center mb-10">
      <div className="w-full md:w-1/3">
        ...
        >
          <div className="w-56 h-56 mb-6 rounded-full overflow-hidden shadow-lg border-4 border-green-200 group-hover:border-green-400 transition-all duration-300 mx-auto">
          ...
          <div className="flex flex-wrap gap-2 justify-center">
            {teamMembers[0].specialties.map((spec, i) => (
              <span 
                key={i} 
    ...
    {/* Next rows: 3x3 grid for the rest */}
    <div className="grid md:grid-cols-3 gap-10">
          ...
          */}
          ...
          <div className="text-center mt-16 animate-fade-in">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button onClick={() => document.querySelector('#partners')?.scrollIntoView({ behavior: 'smooth' })} className={`hover:scale-105 transition-all duration-300 ${theme === 'dark' ? 'bg-white text-black hover:bg-gray-200' : 'bg-black text-white hover:bg-gray-800'}`}>
               Meet our Clients
              </Button>
      ...
      >
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16 animate-fade-in">
            <h2 className="text-4xl md:text-5xl font-playfair font-bold italic mb-8 header-greenland">Catalogue</h2>
            <div className="w-24 header-underline mx-auto mb-8"></div>
            <p className={`text-xl max-w-3xl mx-auto ${theme === 'dark' ? 'text-gray-200' : 'text-gray-700'}`}>Explore our curated collection of films and projects, each telling a unique story and contributing to our legacy of storytelling excellence.</p>
          </div>
          {/* Custom 3x3x1 grid */}
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {catalogueCategories.map((category, idx) => (
              <div 
                ...
                style={{animationDelay: `${idx * 0.1}s`}}
              >
                <div className="relative overflow-hidden flex justify-center items-center" style={{height: '320px'}}>
                  <img 
                    src={category.image} 
                    alt={category.title} 
          ...
          {/* After the 4x4x2 grid, add a full-width landscape card for MANZI */}
          <div className="grid grid-cols-1 mt-8">
            <div 
              className={`group rounded-lg overflow-hidden hover:scale-105 transition-all duration-300 animate-bounce-in shadow-xl ${theme === 'dark' ? 'bg-custom-black' : 'bg-white'}`}
            >
              <div className="relative overflow-hidden flex justify-center items-center" style={{height: '400px'}}>
                <img 
                  src={manziImg} 
                  alt="MANZI" 
                  className="w-full h-full object-contain" 
              ...
              <div className="p-6">
                <h3 className={`text-xl font-bold mb-2 ${theme === 'dark' ? 'text-white' : 'text-black'}`}>MANZI</h3>
                <p className={`text-sm ${theme === 'dark' ? 'text-gray-300' : 'text-gray-600'}`}>A coming-of-age African story about growth, family, and tradition.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      >
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16 animate-fade-in">
            <h2 className="text-4xl md:text-5xl font-playfair font-bold italic mb-8" style={{ color: '#2F5A00' }}>Milestone Achieved</h2>
            <div className="w-24 h-1 mx-auto mb-8"   style={{ backgroundColor: '#2F5A00' }} ></div>
            <p className={`text-xl max-w-3xl mx-auto ${theme === 'dark' ? 'text-gray-200' : 'text-gray-700'}`}>We have successfully progressed and achieved working besides these following

organizations and institutions and we are on track to move forward and work with many more others,

we always appreciate the experience during the time served.</p>
          </div>
        </div>

        {/* FULL WIDTH LOGOS */}
        <div className="w-full bg-white App-Clients App-Clients-Logos px-0">
          <div className="Client-Img-Row">
            {partners.map(partner => (
              <div className="Client-Img-Col" key={partner.id}>
                <img
        ...
        <div className="text-center mt-16 animate-fade-in">
          <p className={`mb-6 ${theme === 'dark' ? 'text-gray-200' : 'text-gray-700'}`}>Interested in working with us?</p>
      ...
      >
        <div className="max-w-4xl mx-auto animate-fade-in">
          <h2 className="text-4xl md:text-5xl font-playfair font-bold italic mb-8 text-center header-greenland">Let's Connect</h2>
          <div className="w-24 header-underline mx-auto mb-8"></div>
          ...
          >
            ...
            <div className="mt-6">
              ...
              <input 
                ...
                required
                className={`w-full px-4 py-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-green-400 transition-all duration-300 ${theme === 'dark' ? 'bg-custom-black text-white border-white' : 'bg-white text-black border-gray-300'}`} 
                placeholder="What type of session are you interested in?" 
              />
            </div>
            <div className="mt-6">
              ...
              <textarea 
                ...
                rows={6} 
                className={`w-full px-4 py-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-green-400 transition-all duration-300 ${theme === 'dark' ? 'bg-custom-black text-white border-white' : 'bg-white text-black border-gray-300'}`} 
                placeholder="Tell me about your vision and any questions you have"
              ></textarea>
            </div>
            {submitStatus === 'success' && (
              <div className={`mt-4 p-4 rounded-lg ${theme === 'dark' ? 'bg-green-900/50 border border-green-200 text-green-300' : 'bg-green-50 border border-green-200 text-green-700'}`}>
                Thank you! Your message has been sent successfully. We'll get back to you soon.
              </div>
            )}
            {submitStatus === 'error' && (
              <div className={`mt-4 p-4 rounded-lg ${theme === 'dark' ? 'bg-red-900/50 border border-red-200 text-red-300' : 'bg-red-50 border border-red-200 text-red-700'}`}>
            ...
            <div className="mt-8 text-center">
              <button 
                ...
                className={`px-8 py-3 rounded-lg hover:scale-105 transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed ${theme === 'dark' ? 'bg-white text-black hover:bg-gray-200' : 'bg-black text-white hover:bg-gray-800'}`}
              >
          ...
          <div className={`flex flex-col items-center gap-4 text-center ${theme === 'dark' ? 'text-white' : 'text-black'}`}>
            ...
            <div className="flex items-center gap-2"><Mail size={18} /> <span>info@greenlandpictures.rw</span></div>
            <div className="flex items-center gap-2"><MapPin size={18} /> <span>Kigali, Rwanda - KN 4 Ave - Car free zone</span></div>
            <div className="flex items-center gap-2 mt-4">
              <a href="https://instagram.com/greenlandpicturesafrica" target="_blank" rel="noopener noreferrer" className="hover:text-pink-600 transition-colors"><Instagram size={24} /></a>
            </div>
          </div>
        </div>
      </section>
